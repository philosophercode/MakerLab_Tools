...
6 tables — IDs configurable via env vars (defaults below are Cornell MakerLab):

| Table | Default ID | Records |
|-------|-----------|---------|
| Tools | `tblXHIT0mN2nOzdhd` | 101 tools |
| Categories | `tblNpVHquh7H0S8Bc` | 9 groups, 37 subcategories |
| Locations | `tblbwtZhuvtuBKlPO` | 3 rooms, 7 zones |
| Units | `tblDtKMcCxTyQbXwi` | Individual physical units |
| Maintenance_Logs | `tbl22sgbMLCFbvynl` | Issue reports & repairs |
| Flags | `tblAK068QYB0vLopa` | Content corrections |
