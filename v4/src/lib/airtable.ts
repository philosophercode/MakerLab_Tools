...
// Table IDs — override via env vars for different AirTable bases
const TABLES = {
  tools: process.env.AIRTABLE_TABLE_TOOLS || "tblXHIT0mN2nOzdhd",
  categories: process.env.AIRTABLE_TABLE_CATEGORIES || "tblNpVHquh7H0S8Bc",
  locations: process.env.AIRTABLE_TABLE_LOCATIONS || "tblbwtZhuvtuBKlPO",
  units: process.env.AIRTABLE_TABLE_UNITS || "tblDtKMcCxTyQbXwi",
  maintenance_logs: process.env.AIRTABLE_TABLE_MAINTENANCE_LOGS || "tbl22sgbMLCFbvynl",
  flags: process.env.AIRTABLE_TABLE_FLAGS || "tblAK068QYB0vLopa",
};
