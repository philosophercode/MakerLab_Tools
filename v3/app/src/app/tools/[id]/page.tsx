...
import ToolMobileToggle from "@/components/ToolMobileToggle";
...
export default async function ToolDetailPage({
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-8">
      {/* Breadcrumb */}
      <nav className="sticky top-14 z-40 -mx-4 mb-0 lg:mb-6 border-b border-card-border bg-background/90 px-4 py-2.5 text-sm text-muted backdrop-blur-sm">
