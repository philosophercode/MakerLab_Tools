...
function Chip({
  ...
  return (
    <span className="inline-flex items-center gap-1 rounded-full bg-cornell-red/10 px-2.5 py-1 text-xs text-cornell-red">
      {label}
      <button
        onClick={onRemove}
        className="ml-0.5 hover:text-cornell-dark"
