    ...
    <div className="space-y-2">
      <div className="flex items-center gap-2">
        <button
          ...
          className="inline-flex items-center gap-1.5 rounded-lg border border-card-border bg-card-bg px-3 py-1.5 text-xs font-medium text-muted hover:text-foreground hover:border-cornell-red transition-colors disabled:opacity-50"
            ...
            <div key={c.imageUrl} className="rounded-lg border border-card-border p-2">
              ...
              <div className="mt-2 flex items-center gap-2">
                <button
                  ...
                  className="rounded border border-card-border px-2 py-1 text-[11px] hover:border-cornell-red"
                >
                  Use
                </button>
                <a
                  ...
                  className="text-[11px] text-cornell-red hover:underline"
                >
                  Source
                </a>
              </div>
      ...
      {(status || errorMsg) && (
        <div
          className={`flex items-center gap-3 rounded-lg border px-3 py-2 text-sm ${
            isProcessing
              ? "border-cornell-red/20 bg-cornell-red/5"
              : status === "done"
        ...
        >
          {isProcessing && (
            <>
              <div className="w-5 h-5 rounded-full border-2 border-cornell-red border-t-transparent animate-spin flex-shrink-0" />
