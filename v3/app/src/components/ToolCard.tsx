  ...
  return (
    <a
      ...
      className={`group block rounded-xl border bg-card-bg overflow-hidden transition-shadow hover:shadow-lg ${
        isProcessing
          ? "border-cornell-red/50 ring-1 ring-cornell-red/20"
          : "border-card-border"
      }`}
    >
      {/* Image */}
            ...
            {isProcessing && (
              <>
                <div className="relative mb-3">
                  <div
                    className="absolute inset-0 rounded-full border-2 border-cornell-red/30 animate-ping"
                    style={{ width: 48, height: 48 }}
                  />
                  <div className="w-12 h-12 rounded-full border-2 border-cornell-red border-t-transparent animate-spin" />
                </div>
        ...
        {!status && !compact && (
          <div className="absolute bottom-2 right-2 flex gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
            <button
              ...
              className="rounded-md bg-card-bg/90 border border-card-border p-1.5 text-muted hover:text-cornell-red hover:border-cornell-red transition-colors backdrop-blur-sm"
